...
A collection of tools, games, and stories a developer mom makes for her kid.
...
| [word-train](https://mama.dev/word-train/) | A phonics game — build words by snapping train cars together |
| [bigger-ramp-jump](https://mama.dev/bigger-ramp-jump/) | Adjust ramp height and angle, launch the truck |
| [bigger-than-race](https://mama.dev/bigger-than-race/) | Number comparison racing game with adaptive difficulty |
